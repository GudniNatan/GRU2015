...
('Bingó', '2015-12-20','Bingó!! Það verður bingó veitingar og vinningar og bara allt. Stærsti vinningurinn er ný apple borðtölva frá epli. Það væri ekki leiðinlegt að fá eina þannig beint í vasann.', 'img/events/bingo.jpg');

INSERT INTO Medlimur(nafn, kennitala, simi, lykilord)
VALUES
...
SELECT heiti, dagsetning, ummaeli, myndURL, id FROM Vidburdur WHERE dagsetning > CURDATE() ORDER BY dagsetning LIMIT 4